object frmRelClinAniversariantes: TfrmRelClinAniversariantes
  Left = 224
  Top = 146
  ...
  object dstClientes: TSQLDataSet
    CommandText = 
      'select CLI_CODIGO, CLI_FANTASIA, CLI_RAZAO, CLI_FONE1, CLI_DTANI' +
      'VERSARIO from CLIENTES order by CLI_FANTASIA'
    MaxBlobSize = -1
    Params = <>
  ...
  object ppReport1: TppReport
    ...
    Template.FileName = 'C:\EMPRESA\SERVICO\DELPHI\Relatorios\rbClientesAniversario.rtm'
    Units = utMillimeters
    DeviceType = 'Screen'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object lblRelatorio: TppLabel
        ...
        Caption = 'RELA'#199#195'O DE CLIENTES ANIVERSARIANTES'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Name = 'Arial'
        Font.Size = 10
  ...
  object dstContatos: TSQLDataSet
    CommandText = 
      'Select CON_CODIGO, CLI_CODIGO, CON_NOME, CON_DATANASC, CON_FONE,' +
      ' CON_CELULAR'#13#10'from CONTATOS order by CON_NOME, CON_DATANASC;'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = Dm.SqlAdmin
    Left = 152
