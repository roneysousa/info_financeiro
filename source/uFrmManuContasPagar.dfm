object frmManuContasPagar: TfrmManuContasPagar
  Left = 168
  Top = 221
  ...
  object dsContasPagar: TDataSource
    DataSet = DM2.cdsContasPagar
    OnDataChange = dsContasPagarDataChange
    Left = 544
    Top = 24
  end
  ...
  object cdsContasPagar: TClientDataSet
    ...
    object cdsContasPagarPAG_NMFORNECEDOR: TStringField
      FieldKind = fkLookup
      FieldName = 'PAG_NMFORNECEDOR'
      LookupDataSet = DM2.cdsFornecedor
