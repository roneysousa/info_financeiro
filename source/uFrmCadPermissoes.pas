...
uses Udm, uFuncoes, uFrmUsuarios, UFrmAdmin, uFrmTarefaUsuario;
...
begin
     M_CDUSUA := StrtoInt(DBText2.Caption);
     //
     Dm.Start;
     try
          With cdsPermissoes do
                 ...
                 While not (Eof) do
                  begin
                       ...
                       Else
                           aExcluir := 'N';
                       //
                       Dm.Incluir_Acesso_Usuario(M_CDUSUA, cdsPermissoesCODIGO.AsInteger,
            ...
            If (cbxAdmin.Checked) Then
                DM.SetAdminUsuario(M_CDUSUA, 'T')
            Else
                DM.SetAdminUsuario(M_CDUSUA, 'F');
            //
          Dm.Comit(Dm.Transc);
          //
...
begin
     ...
     begin
         ...
         Incluir_Dados_Usuario(StrtoInt(DBText2.Caption));
     End;
     //
     {If not (Dm.ValidarAcesso(StrtoInt(DBText2.Caption)) ) Then
         Dm.Acessos_Sistema(cdsPermissoes, 1, 0)
     Else}
     Dm.Acessos_Sistema(cdsPermissoes, 2, StrtoInt(DBText2.Caption));
     //
     ...
     //
     If (dm.cdsUsuariosUSU_ADMIN.AsString = 'T') Then
          ...
          With cdsPermissoes do
            begin
                 ...
                 While not (Eof) do
                  begin
                       //
                       Dm.Incluir_Acesso_Usuario(aUsuario, cdsPermissoesCODIGO.AsInteger,
                              cdsPermissoesMENU_NOME.AsString,
                              'N', 'N', 'N', 'N');
                       //
                       Next;
...
procedure TfrmCadPermissoes.btnTarefasClick(Sender: TObject);
begin
    FrmAdmin.AbreForm(TfrmTarefaUsuarios, frmTarefaUsuarios);
end;
