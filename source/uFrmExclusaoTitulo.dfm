object frmExclusaoTitulo: TfrmExclusaoTitulo
  Left = 191
  Top = 112
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Exclus'#227'o de Presta'#231#227'o'
  ClientHeight = 482
  ClientWidth = 593
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object edtNRPARC: TEdit
      ...
      Height = 21
      TabOrder = 2
      OnChange = edtNRPARCChange
      OnExit = edtNRPARCExit
      OnKeyPress = edtNRPARCKeyPress
    end
    ...
    object DBEdit10: TDBEdit
      ...
      Width = 212
      Height = 21
      DataField = 'DEB_VLPAGO'
      DataSource = Dm.dsDebito
      TabOrder = 11
    end
    ...
    object dbeMTEXCLU: TDBEdit
      Left = 16
      Top = 408
      Width = 550
      Height = 21
      DataField = 'DEB_MOTIVOEXCLUSAO'
      DataSource = Dm.dsDebito
      TabOrder = 15
      Visible = False
    end
  ...
  object dstContasReceber: TSQLDataSet
    CommandText = 
      'Select * from CONTASRECEBER Where (REC_LOJA = :pLOJA)'#13#10'AND (REC_' +
      'CREDITO = :pNRCREDITO) '#13#10'AND (REC_PARCELA = :pPARCELA)'#13#10#13#10
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    object dstContasReceberREC_PARCELA: TStringField
  ...
  object cdsContasReceber: TClientDataSet
    ...
    object cdsContasReceberREC_PARCELA: TStringField
      FieldName = 'REC_PARCELA'
      Required = True
      FixedChar = True
      Size = 2
