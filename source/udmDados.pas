...
begin
     ...
     try
        ...
        M_TEXTO2 := Copy(linha,53,5);  // Agência mantendora da conta
        M_TEXTO3 := Copy(linha,58,1);  // Dígito verificador da Agência
        M_TEXTO4 := Copy(linha,59,12); // Número da Conta Corrente
        M_TEXTO5 := Copy(linha,71,1);  // Dígito verificador Conta Corrente
              ...
              begin
                  ...
                  begin
                     ...
                     begin
                         ...
                         // Valor de Outros Créditos 123 - 137 : 13
                         ValorOutrosCreditos  := StrtoFloat(Copy(linha,123,13))/100;
                         // Valor Líquido a ser Creditado  93 - 107 : 13
