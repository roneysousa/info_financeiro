object frmContasReceber: TfrmContasReceber
  ...
  object PageControl1: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object edtDTMOVI: TDBEdit
        Left = 16
        Top = 144
        Width = 121
        Height = 21
        DataField = 'DEB_DTMOVIMENTO'
        DataSource = Dm.dsDebito
        TabOrder = 2
      end
  ...
  object datasetConsultar: TSQLDataSet
    CommandText = 
      'Select DEB_LOJA, DEB_NRCREDITO, CLI_CODIGO, DEB_PARCELA, DEB_DES' +
      'CRICAO, DEB_DTMOVIMENTO, DEB_DTVENCIMENTO, DEB_DTPAGAMENTO, DEB_' +
      'VLPARCELA from DEBITO'#13#10'Where (DEB_DTVENCIMENTO BETWEEN :pDTINIC ' +
      'AND :pDTFINA)'#13#10'order by DEB_DTVENCIMENTO'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftDate
  ...
  object cdsConsultar: TClientDataSet
    ...
    Left = 468
    Top = 226
    object cdsConsultarDEB_LOJA: TIntegerField
      FieldName = 'DEB_LOJA'
      Required = True
      DisplayFormat = '000'
    end
    object cdsConsultarDEB_NRCREDITO: TIntegerField
      FieldName = 'DEB_NRCREDITO'
      Required = True
    ...
    object cdsConsultarDEB_PARCELA: TStringField
      FieldName = 'DEB_PARCELA'
      FixedChar = True
      Size = 2
    end
    object cdsConsultarDEB_DESCRICAO: TStringField
      FieldName = 'DEB_DESCRICAO'
      Size = 50
    end
    object cdsConsultarDEB_DTMOVIMENTO: TDateField
      Alignment = taRightJustify
      FieldName = 'DEB_DTMOVIMENTO'
      EditMask = '99/99/9999'
    end
    object cdsConsultarDEB_DTVENCIMENTO: TDateField
      Alignment = taRightJustify
      FieldName = 'DEB_DTVENCIMENTO'
      EditMask = '99/99/9999'
    end
    object cdsConsultarDEB_DTPAGAMENTO: TDateField
      Alignment = taRightJustify
      FieldName = 'DEB_DTPAGAMENTO'
      EditMask = '99/99/9999'
    end
    object cdsConsultarDEB_VLPARCELA: TFMTBCDField
      FieldName = 'DEB_VLPARCELA'
      DisplayFormat = '###,###,##0.#0'
      Precision = 15
      Size = 2
