object frmInvertario: TfrmInvertario
  ...
  object qryLojas: TSQLQuery
    ...
    Left = 248
    Top = 49
    object qryLojasEMP_CODIGO: TIntegerField
      FieldName = 'EMP_CODIGO'
      Required = True
    end
    object qryLojasEMP_FANTASIA: TStringField
      FieldName = 'EMP_FANTASIA'
      Size = 50
    end
    object qryLojasEMP_RAZAO: TStringField
      FieldName = 'EMP_RAZAO'
      Size = 50
    end
  end
  object qryProduto: TSQLQuery
    ...
    SQL.Strings = (
      'Select PRO_CODIGO, UNI_CODIGO from PRODUTOS'
