object frmRelacaoProdutos: TfrmRelacaoProdutos
  Left = 242
  Top = 199
  ...
  object dstProdutos: TSQLDataSet
    CommandText = 
      'Select P.PRO_CODIGO, P.PRO_DESCRICAO, P.PRO_VLCOMPRA, FOR_CODIGO' +
      ','#13#10'P.PRO_VLVENDA, P.UNI_CODIGO, P.TRI_CODIGO,'#13#10'(Select TR.TRI_DE' +
      'SCRICAO from TRIBUTACAO TR Where (TR.TRI_CODIGO = P.TRI_CODIGO))' +
      ' TRI_DESCRICAO'#13#10'from PRODUTOS P'#13#10
    MaxBlobSize = -1
    Params = <>
    ...
    object dstProdutosTRI_DESCRICAO: TStringField
  ...
  object cdsProdutos: TClientDataSet
    ...
    object cdsProdutosTRI_DESCRICAO: TStringField
      FieldName = 'TRI_DESCRICAO'
      FixedChar = True
    end
  ...
  object ppRelProdutos: TppReport
    ...
    Template.FileName = 'C:\Empresa\SERVICO\DELPHI\Relatorios\rbRelacaoProdutos.rtm'
    Units = utMillimeters
    DeviceType = 'Screen'
