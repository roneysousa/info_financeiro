object frmRelTotalProdutos: TfrmRelTotalProdutos
  Left = 228
  Top = 201
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Relat'#243'rio Total Vendido de Produtos'
  ClientHeight = 204
  ClientWidth = 350
  Color = clBtnFace
  ...
  object ppReport1: TppReport
    AutoStop = False
    DataPipeline = ppDBPTotalProduto
    ...
    Template.FileName = 'C:\EMPRESA\SERVICO\DELPHI\Relatorios\rbTotalProdutosVendidos.rtm'
    Units = utMillimeters
    DeviceType = 'Screen'
    ...
    Version = '7.01'
    mmColumnWidth = 0
    DataPipelineName = 'ppDBPTotalProduto'
  ...
  object dsTotalProdutos: TDataSource
    DataSet = dmRelatorios.cdsTotalProdutos
    Left = 248
    Top = 120
  end
  object ppDBPTotalProduto: TppDBPipeline
    DataSource = dsTotalProdutos
    UserName = 'DBParametros1'
    Left = 280
    Top = 120
    object ppDBPTotalProdutoppField1: TppField
      Alignment = taRightJustify
      FieldAlias = 'HIS_LOJA'
      FieldName = 'HIS_LOJA'
      FieldLength = 0
    ...
    object ppDBPTotalProdutoppField2: TppField
    ...
    object ppDBPTotalProdutoppField3: TppField
      Alignment = taRightJustify
      FieldAlias = 'TOTAL'
      FieldName = 'TOTAL'
      FieldLength = 3
    ...
    object ppDBPTotalProdutoppField4: TppField
      FieldAlias = 'PRO_NOME'
      FieldName = 'PRO_NOME'
      FieldLength = 60
      DisplayWidth = 60
    ...
    object ppDBPTotalProdutoppField5: TppField
      Alignment = taRightJustify
    ...
    object ppDBPTotalProdutoppField6: TppField
      FieldAlias = 'HIS_VLTOTAL'
