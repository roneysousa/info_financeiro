object frmRelVendaCaixa: TfrmRelVendaCaixa
  Left = 263
  Top = 191
  BorderIcons = [biSystemMenu]
  BorderStyle = bsSingle
  Caption = 'Relatorio Venda por Operador de Caixa'
  ClientHeight = 176
  ClientWidth = 339
  Color = clBtnFace
  ...
  object pnlDados: TPanel
    ...
    object edtCDCAIXA: TEdit
      ...
      MaxLength = 3
      TabOrder = 0
      OnChange = edtCDCAIXAChange
      OnExit = edtCDCAIXAExit
      OnKeyPress = edtCDCAIXAKeyPress
    end
  end
  ...
  object dstCaixa: TSQLDataSet
    CommandText = 
      'Select V.mov_pedido, U.sen_nome, M.mca_dtmovimento, M.mca_hrmovi' +
      'mento,'#13#10'V.mov_nomecliente, V.MOV_VALOR'#13#10'from VENDAS V'#13#10'INNER joi' +
      'n MOVIMENTO_CAIXA M ON M.mca_venda = V.mov_pedido'#13#10'INNER join US' +
      'UARIOS U ON U.SEN_CODIGO = M.MCA_CAIXA'#13#10'Where (M.MCA_CAIXA = :pC' +
      'AIXA) AND (M.MCA_TIPOMOV = '#39'V'#39')'#13#10'Group by V.mov_pedido, U.sen_no' +
      'me, M.mca_dtmovimento, M.mca_hrmovimento,'#13#10'V.mov_nomecliente, V.' +
      'MOV_VALOR '
    MaxBlobSize = -1
    Params = <
      item
  ...
  object cdsCaixa: TClientDataSet
    ...
    Left = 80
    Top = 143
    object cdsCaixaSEN_NOME: TStringField
      FieldName = 'SEN_NOME'
      Size = 40
    end
    object cdsCaixaMCA_DTMOVIMENTO: TDateField
      FieldName = 'MCA_DTMOVIMENTO'
    end
    object cdsCaixaMCA_HRMOVIMENTO: TStringField
      FieldName = 'MCA_HRMOVIMENTO'
      FixedChar = True
      Size = 5
    end
    object cdsCaixaMOV_NOMECLIENTE: TStringField
      FieldName = 'MOV_NOMECLIENTE'
      Size = 40
    end
    object cdsCaixaMOV_VALOR: TFMTBCDField
      FieldName = 'MOV_VALOR'
      Precision = 15
      Size = 2
    end
  ...
  object ppReport1: TppReport
    ...
    Template.FileName = 'C:\EMPRESA\SERVICO\DELPHI\Relatorios\rbRelVendasOperCaixa.rtm'
    Units = utMillimeters
    DeviceType = 'Screen'
    ...
    object ppHeaderBand1: TppHeaderBand
      ...
      object ppLabel8: TppLabel
        ...
        Caption = 'RELAT'#211'RIO : VENDAS POR OPERADOR DE CAIXA'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clWindowText
        Font.Name = 'Arial'
        Font.Size = 10
