...
begin
  ...
  if dm.CdsContatos.RecordCount > 0 then
     ...
     Begin
           aCodigo  := uFuncoes.StrZero(dm.CdsContatosCON_CODIGO.AsString,7);
           aCliente := uFuncoes.StrZero(dm.CdsContatosCLI_CODIGO.AsString,7);
           ...
           If not (dm.IncluirTarefaUsuario(iUsuario,
             'Excluiu Contato : '+aCodigo+' do Cliente : '+aCliente+ '*F*')) Then
